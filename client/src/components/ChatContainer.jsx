...
const ChatContainer = () => {
  ...
  return selectedUser ? (
    <div className='h-full overflow-scroll relative backdrop-blur-lg'>
      {/*------- header area-------- */}
      <div className='flex items-center gap-3 py-3 mx-4 border-b border-stoe-500 '>
        <img src={selectedUser.profilePic || assets.avatar_icon} 
        alt="profile" className='w-8 rounded-full' />
        ...
        className='md:hidden max-w-7' onClick={() => setSelectedUser(null)} />
      ...
      <div className='absolute bottom-0 left-0 right-0 flex items-center gap-3 p-3 '>
        <div className='flex-1 flex items-center bg-gray-100/12 px-3 rounded-full '>
          ...
          type="file" id='image' accept='image/jpeg image/png image/jpg' hidden/>
          <label htmlFor="image">
